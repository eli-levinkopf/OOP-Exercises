...
import bricker.paddle_strategies.PaddleStrategyFactory;
...
public class BrickerGameManager extends GameManager {
    ...
    public void initializeGame(ImageReader imageReader, SoundReader soundReader,
        ...
        PaddleStrategyFactory paddleStrategyFactory = new PaddleStrategyFactory(gameObjects());
        BrickStrategyFactory brickStrategyFactory = new BrickStrategyFactory(gameObjects(), bricksCounter, soundReader,
                imageReader, inputListener, windowController, paddleStrategyFactory, gameManager);
        windowDimensions = windowController.getWindowDimensions();
        this.windowController = windowController;
        addBall(imageReader, soundReader);
        addPaddle(imageReader, inputListener, paddleStrategyFactory);
        addFrame();
...
//            gameObjectsCollection.addGameObject(graphicLifeCounter);
    ...
    private void addPaddle(ImageReader imageReader, UserInputListener inputListener, PaddleStrategyFactory paddleStrategyFactory) {
        ...
        Paddle paddle = new Paddle(Vector2.ZERO, new Vector2(PADDLE_DIMENSION_X, PADDLE_DIMENSION_Y), paddleImage,
                inputListener, windowDimensions, paddleStrategyFactory.getStrategy(), true);
    ...
    private void addBall(ImageReader imageReader, SoundReader soundReader) {
        ...
        GameObject ball = new Ball(Vector2.ZERO, new Vector2(BALL_DIMENSION, BALL_DIMENSION), ballImage, collisionSound, gameManager);
