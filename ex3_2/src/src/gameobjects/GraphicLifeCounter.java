...
public class GraphicLifeCounter extends GameObject {
     ...
     */
    public GraphicLifeCounter(Vector2 widgetTopLeftCorner, Vector2 widgetDimensions, Renderable widgetRenderable,
                              Counter livesCounter,GameObjectCollection gameObjectsCollection, int numOfLives) {
